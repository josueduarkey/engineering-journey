  ...
  return (
    <section className="flex flex-1 flex-col items-center justify-center px-6 py-32 text-center">
      ...
      <p className="max-w-xl text-lg leading-relaxed text-neutral-500 dark:text-neutral-400">
        Proyectos, aprendizajes y reflexiones a lo largo de una carrera.
      </p>
      <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
        ...
        <Link
          href="/projects"
          className="rounded-full border border-neutral-200 bg-[var(--bg)] px-6 py-3 text-sm font-semibold text-neutral-700 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800"
        >
          {t("projects")}
        </Link>
      </div>
